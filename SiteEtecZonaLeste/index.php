...
<li><a href="gestao.php">Gestão</a></li>
    ...
    <section>
        ...
        <p>
            A Etec Zona Leste possui uma Sala Maker equipada com diversos recursos
            tecnológicos que permitem aos alunos desenvolver projetos, estimular a
            criatividade e colocar ideias em prática por meio da inovação.
        </p>
...
<section>
    ...
    <p>
        Nosso auditório é um espaço moderno e climatizado, ideal para palestras, 
        apresentações de projetos, defesas de TCC e eventos culturais. Equipado com 
        sistema de som e projeção de alta qualidade, oferece conforto e tecnologia 
        para receber alunos, professores e a comunidade.
    </p>
    ...
    <section>
        ...
        <div class="cards-container">
            ...
            <div class="card">
                ...
                <p>Evento anual que reúne as melhores ideias tecnológicas desenvolvidas na escola.</p>
            </div>
        </div>
